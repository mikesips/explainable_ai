...
demo_cases = {
    'Lucas Organic Carbon (PCA)': {
        'target': 'lucas_organic_carbon/target/lucas_organic_carbon_target.csv',
        'training': 'lucas_organic_carbon/training_test/compressed_data.csv'
    },
    'Lucas Organic Carbon (AE)': {
        'target': 'lucas_organic_carbon/target/lucas_organic_carbon_target.csv',
        'training': 'lucas_organic_carbon/training_test/autoencoder_predictions.csv'
    },
    'Iris Dataset': {
